...
class CheckTest(unittest.TestCase):
    def setUp(self):
    #     self.api = Api(api_key=api_key, api_username=api_username, base_url=base_url)
    ...
    def test_check_url_1(self):
        self.assertEqual("https://apitest.sendyit.com/v1/", check_url("https://apitest.sendyit.com/v1"))
    ...
    def test_check_url_5(self):
        self.assertEqual("https://api.sendyit.com/v1/", check_url("https://api.sendyit.com/v1/"))

    def test_check_url_6(self):
        self.assertEqual("https://private-faab6-sendypublicapi.apiary-mock.com/v1/", check_url("https://private-faab6-sendypublicapi.apiary-mock.com/v1/"))

    def test_check_url_7(self):
        self.assertRaises(SendyException, check_url, "https://private-faab6-sendypublicapi.apiary.com/v1")
    ...
    def test_check_location_details_empty_name_1(self):
        ...
        self.assertRaises(SendyException, check_location_details, self.location_data)
    ...
    def test_check_person_details_empty_name_1(self):
        ...
        self.assertRaises(SendyException, check_person_details, self.person_data)
    ...
    def test_check_package_size_empty_weight_1(self):
        ...
        self.assertRaises(SendyException, check_package_size, self.package_size)
    ...
    def test_check_collect_payment_empty_status_1(self):
        ...
        self.assertRaises(SendyException, check_collect_payment, self.payment_data)
    ...
    def test_check_delivery_details_empty_pick_up_date_1(self):
        ...
        self.assertRaises(SendyException, check_delivery_details, self.delivery_data)
    ...
    def test_check_delivery_details_collect_payment_1(self):
        self.assertEqual(self.delivery_data['collect_payment'], check_delivery_details(self.delivery_data)['collect_payment'])

    def test_check_delivery_details_package_size_1(self):
        self.assertEqual(self.delivery_data['package_size'], check_delivery_details(self.delivery_data)['package_size'])
